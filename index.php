...
<html>
  ...
  <body class="wtf">
    ...
    <h2 id="eventtitle"><a class="titlelink" href="http://www.lmgtfy.com/?q=<?echo urlencode($json_object[0]->event_desc)?>" target="_blank"><?echo $json_object[0]->event_desc;?></a></h2>
    <div id="eventinfo">
